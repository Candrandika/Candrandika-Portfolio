        ...
        <div className="container flex flex-col items-center h-full mx-auto xl:flex-row gap-x-6">
          ...
          <div className="flex flex-col justify-center flex-1">
            ...
            <motion.p 
              ...
              animate="show"
              exit="hidden"
              className="max-w-[500px] mx-auto xl:mx-0 mb-6 mb-12 px-2 xl:px-0"
            >
              18 years ago, I began freelancing as a developer. Since then, i{"'"}ve done remote work for agencies, counsulted for startups, and collaborated on digital products for business and consumer use.
            </motion.p>
            {/* counters */}
            <motion.div
